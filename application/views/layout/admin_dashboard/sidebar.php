...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
    ...
    <div class="sidebar-brand-text mx-3">Peduli Bersama</div>
...
<li class="nav-item">
    <a class="nav-link" href="<?= base_url('index.php/admin/transaction_draft')?>" >
        <i class="fas fa-fw fa-cog"></i>
        <span>Konfirmasi Transaksi User</span>
    </a>
   
</li>
<li class="nav-item">
    <a class="nav-link" href="<?= base_url('index.php/admin/transaction_draft_cabang')?>" >
        <i class="fas fa-fw fa-cog"></i>
        <span>Konfirmasi Transaksi Cabang</span>
    </a>
...
<!-- Nav Item - Pages Collapse Menu -->
<li class="nav-item">
    <a class="nav-link collapsed" href="<?= base_url('index.php/admin/data_sedekah')?>"s>
        <i class="fas fa-fw fa-folder"></i>
        <span>Data Wakaf</span>
    </a>
