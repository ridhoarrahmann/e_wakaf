    ...
    <div class="content">
        <div class="form-sedekah-container">
            <div class="form">
            <h1 style="text-align:center;">Form Sedekah</h1>
            <small><?= form_error('username') ?> </small>
                    
            <form method="post" action="<?= base_url('index.php/admin_cabang/add_sedekah')?>" class="d-flex justify-content-center">
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" class="form-sedekah" name="category" id="category" value="sedekah" ></td>
                </tr>
                <tr>
